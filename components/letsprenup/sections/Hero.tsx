      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16 w-full flex-grow grid lg:grid-cols-12 items-center gap-8 pt-20 pb-16">
        ...
        <div className="lg:col-span-7 pt-12 pb-8 lg:pt-0 lg:pb-0 relative z-10">
          ...
          <div className="rv flex flex-wrap items-center gap-4 mb-10">
            <a
              href="#pricing"
              className="bg-rose text-white px-8 py-3.5 rounded-full text-[13px] font-semibold tracking-wider uppercase inline-flex items-center gap-3 hover:bg-rose-soft transition-colors shadow-lg"
            >
          ...
          {/* Social Proof Badges */}
          <div className="rv flex items-center gap-5 border-t border-white/10 pt-6">
            <div className="flex -space-x-2">
              <div className="w-7 h-7 rounded-full bg-slate border-2 border-midnight flex items-center justify-center text-[10px] text-mist font-medium">
                JR
              </div>
              <div className="w-7 h-7 rounded-full bg-midnight-mid border-2 border-midnight flex items-center justify-center text-[10px] text-mist font-medium">
                SK
              </div>
              <div className="w-7 h-7 rounded-full bg-rose-deep border-2 border-midnight flex items-center justify-center text-[10px] text-white font-medium">
                MR
              </div>
              <div className="w-7 h-7 rounded-full bg-steel border-2 border-midnight flex items-center justify-center text-[10px] text-white font-medium">
                +
              </div>
            </div>
            <div>
        ...
        {/* Right Photo Column */}
        <div className="lg:col-span-5 hidden lg:block h-[68vh] relative">
